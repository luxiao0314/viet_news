package cn.magicwindow.tablayout;
...
import cn.magicwindow.tablayout.utils.FragmentChangeManager;
import cn.magicwindow.tablayout.utils.UnreadMsgUtils;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private boolean mTextVisiable;
    private boolean mText2Visiable;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextVisiable = ta.getBoolean(R.styleable.CommonTabLayout_tl_textVisible, true);
        mText2Visiable = ta.getBoolean(R.styleable.CommonTabLayout_tl_text2Visible, false);
    ...
    private void addTab(final int position, View tabView) {
        ...
        TextView tv2_tab_title = tabView.findViewById(R.id.tv2_tab_title);
        tv2_tab_title.setText(mTabEntitys.get(position).getTabTitle2());
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (mTextVisiable) {
                //设置第二行文字是否可见
                if (mText2Visiable) {
                    tv2_tab_title.setVisibility(View.VISIBLE);
                } else {
                    tv2_tab_title.setVisibility(View.GONE);
                }
                tv_tab_title.setVisibility(View.VISIBLE);
                tv_tab_title.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
                tv2_tab_title.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView tab2_title = tabView.findViewById(R.id.tv2_tab_title);
            tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
            tab2_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
            ImageView iv_tab_icon = tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntitys.get(i);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public View getItemView(int tab) {
