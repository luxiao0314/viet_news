package com.viet.news.core.ui.progress;
        ...
        return Glide.with(getContext())
                ...
                .listener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        ...
                        ProgressInterceptor.removeProgressListener(internalProgressListener);
                        return false;
                    }
    ...
    private void addProgressListener() {
        ...
        internalProgressListener = new OnProgressListener() {
            ...
            public void onProgress(String imageUrl, long bytesRead, long totalBytes, boolean isDone, GlideException exception) {
                ...
                if (isDone) {
                    ProgressInterceptor.removeProgressListener(this);
                }
            }
        };
        ProgressInterceptor.addProgressListener(internalProgressListener);
    }
